...
export function sampleSchedule(): Schedule {
  return { metadata: { id: 'synthetic', displayName: 'Demo', sourceFileName: 'synthetic.pdf', importedAt: '2026-09-01T12:00:00Z', coverageStart: '2026-10-01', coverageEnd: '2026-10-03' }, days: [
    { date: '2026-10-01', status: 'work', shift: { kind: 'single', serviceId: 'SYN-01', presenceStart: '21:00', presenceEnd: '25:31', workedMinutes: 240, rrMinutes: 31, pay: '12.34', origin: 'Alfa', destination: 'Beta', blocks: [{ ordinal: 1, start: '21:00', end: '25:31', trips: [{ start: '21:10', end: '25:20', origin: 'Alfa', destination: 'Beta', line: 'D1', vehicle: 'V-001' }] }] } },
